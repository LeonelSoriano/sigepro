$(document).ready(function() {
		...
		/*$("#x_fecha_inicio").datepicker({todayHighlight: true, format: 'dd-mm-yyyy'});*/
		$("#datepicker_final").datepicker({todayHighlight: true});
		...
		$('#x_hora_inicio').datetimepicker({ // Time
			format: "hh:ii",
        	weekStart: 1,
        	todayBtn:  1,
			autoclose: 1,
		...
		$('#x_hora_final').datetimepicker({ // Time
			format: "hh:ii",
        	weekStart: 1,
        	todayBtn:  1,
			autoclose: 1,
		...
		$('#x_hora_fin').datetimepicker({ // Time
			format: "hh:ii",
        	weekStart: 1,
        	todayBtn:  1,
			autoclose: 1,
