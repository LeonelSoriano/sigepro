(function($) {
    ...
    var props = [{
        title : 'DST Logistic Office',
        image : '1-1-thmb.png',
        type : 'Office',
        price : '',
        address : '18215 Ammi Trail, Houston, TX 77060, EE. UU.',
        bedrooms : '',
        bathrooms : '',
        area : '',
        position : {
        ...
        $.each(props, function(i,prop) {
            ...
            var infoboxContent = '<div class="infoW">' +
                                    '<div class="propImg">' +
                                        ...
                                        '<div class="propBg">' +
                                            '<div class="propPrice" style="display: none;">' + prop.price + '</div>' +
                                    ...
                                    '</div>' +
                                    '<div class="propRating" style="display: none;">' +
                                    ...
                                    '</div>' +
                                    '<ul class="propFeat" style="display: none;">' +
                                    ...
                                    '<div class="infoButtons" style="display: none;">' +
    ...
    setTimeout(function() {
        ...
        map.setCenter(new google.maps.LatLng(29.9650251,-95.3978797));
        map.setZoom(15);
        ...
        if ($('#address').length > 0) {
            newMarker = new google.maps.Marker({
                position: new google.maps.LatLng(29.9650251,-95.3978797),
                map: map,
                icon: new google.maps.MarkerImage(
