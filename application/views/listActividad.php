...
<div class="page-heading">
    <h1><i class="fa fa-user"></i> Listado de Actividades</b></h1>
    <!---->
...
<div class="container-fluid">
    ...
    <table id="example" class="display" cellspacing="0" width="100%">
     ...
     <td><a href=\"javascript:void(0)\" id=\"detailAjax\"
             onclick='loadAjaxtListView(18,$index->codigo)'      class=\"btn btn-info-alt\"><i class=\"fa fa-folder-open-o\"></i> Tarea</a>
    ");
            echo ("
...
<div style="margin-top: 20px">
    ...
    <input type="button" style="margin-right: 10px" class="pullRight btn btn-success" name="btnAction" id="newActividad" value="Nueva Actividad"/>
</div>
